...
let post = exports.post = (() => {
  var _ref3 = _asyncToGenerator(function* (path, data) {
    try {
      const { data } = yield _axios2.default.post(`${API_URL}/${path}`, AXIOS_CONFIG);
...
let getMessages = exports.getMessages = (() => {
  var _ref4 = _asyncToGenerator(function* (channelID, after) {
    try {
  ...
  return function getMessages(_x4, _x5) {
...
let outputFile = exports.outputFile = (() => {
  var _ref6 = _asyncToGenerator(function* (qna) {
    try {
  ...
  return function outputFile(_x6) {
